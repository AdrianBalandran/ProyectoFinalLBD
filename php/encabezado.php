        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-end">
                    <form class="d-flex position-relative" role="search" action="Buscador.php" method="POST">
                    ...
                    <?php 
                        if(!isset($_SESSION['usuario'])){?>
                            <a href="login.php" class="navbar-nav" data-bs-toggle="tooltip" data-bs-title="Iniciar Sesión">
                                <span class="nav-link">
                                    <i class="fa-solid fa-user"></i>
                                </span>
                            </a>
                        <?php } elseif(isset($_SESSION['usuario'])){ ?>
                            <a href="logout.php" class="navbar-nav" data-bs-toggle="tooltip" data-bs-title="Cerrar Sesión">
                                <span class="nav-link">
